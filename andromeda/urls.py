...
urlpatterns = [
    ...
    url(r'^recordatoriosPendientes/$',recordatoriosPendientes,name='recordatoriosPendientes'),
    url(r'^eliminarRecordatorio/$',eliminarRecordatorio,name='eliminarRecordatorio'),
    url(r'^completarRecordatorio/$',completarRecordatorio,name='completarRecordatorio'),
    url(r'^graficar/$',graficar,name='graficar'),
